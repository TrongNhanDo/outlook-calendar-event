...
app.get('/sync', function (req, res) {
   ...
   // const urlAPI = 'https://outlook.office.com/api/v2.0';
   const urlAPI = 'https://graph.microsoft.com/v1.0';

   // Set the endpoint to API v2
   outlook.base.setApiEndpoint(urlAPI);
...
app.get('/viewitem', function (req, res) {
   ...
   var select = {
      $select:
         'Subject,Attendees,Location,Start,End,IsReminderOn,ReminderMinutesBeforeStart',
   };
